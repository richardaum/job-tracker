...
- [P-92] A user can save a valid salary row (or clear it) and immediately see the same values on the list card and the details `Overview` after refetch, with API rejecting inconsistent partial states defined by the technical scope.
