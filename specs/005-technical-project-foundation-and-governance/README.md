...
> **Migrated** from `.specs/beta1/technical/PROJECT-FOUNDATION-AND-GOVERNANCE.md`. Links in the body may still reference `.specs/`; update them to this tree under `specs/` when editing.
