import { CopyIcon, DotsThreeOutlineVerticalIcon, PencilSimpleIcon, TrashIcon } from "@phosphor-icons/react";
...
export const Default: Story = {
  render: () => (
    ...
    >
      <DropdownMenuItem icon={<PencilSimpleIcon size={14} weight="regular" />}>Edit job</DropdownMenuItem>
