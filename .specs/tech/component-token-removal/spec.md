...
**Milestone:** M2  
**Status:** Done  
**Depends on:** `.specs/tech/design-system/spec.md`  
**Design:** `./design.md`  
**Tasks:** `./tasks.md`
...
7. Documentation under `.specs/tech/design-system` and this feature reflects a two-tier token model + component-local definitions
