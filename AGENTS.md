...
| `worktree`, `git worktree`, `@worktree-loop`, `worktree-loop`, `subagent`, `2 passes`, `reintegrate`, `follow-up work`, `opencode`, `cursor`, `claude code` | `worktree.md`, `worktree-loop` skill |
