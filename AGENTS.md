...
| `worktree.md`                | Worktrees, code-agent handoff, WORKTREE.md reintegration         |
...
| `worktree`, `git worktree`, `WORKTREE.md`, `reintegrate`, `opencode`, `cursor`, `claude code` | `worktree.md`                |
