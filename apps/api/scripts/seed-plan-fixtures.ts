...
import remoteyeahFixture from "@api/domains/sources/fixtures/plan3.example.json";
import telegramFixture from "@api/domains/sources/fixtures/plan2.example.json";
