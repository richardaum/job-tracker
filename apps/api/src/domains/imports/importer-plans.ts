...
import remoteyeahPlanFixture from "@api/domains/imports/fixtures/remoteyeah.plan.json";
...
/** Listing URL for `ImportRun`: first literal `tab.open`, or `collect.jobs` `input.surfaceUrl`. */
