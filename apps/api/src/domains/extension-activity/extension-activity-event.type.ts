...
export class ExtensionActivityEvent {
  ...
  @Field(() => ExtensionActivityEventTypeEnum, {
    description: "Event category (source run lifecycle, import, auth).",
  })
  ...
  @Field(() => String, {
    nullable: true,
    description: "Groups related events (e.g. run ID).",
  })
  ...
  @Field(() => String, {
    nullable: true,
    description: "Extension version that reported the event.",
  })
