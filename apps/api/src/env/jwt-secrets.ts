...
const jwtSecretsJsonSchema = z.object({ current: z.string().min(1), previous: z.string().min(1).optional() });

export function parseJwtSecretPair(jsonSecrets: string | undefined, singleSecret: string | undefined): JwtSecretPair {
