...
export class CreateCompanies1749000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    for (const app of applications) {
      ...
      await queryRunner.query(`UPDATE "applications" SET company_id = $1 WHERE id = $2`, [companyId, app.id]);
    }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "applications_company_id_companies_id_fk"`);
