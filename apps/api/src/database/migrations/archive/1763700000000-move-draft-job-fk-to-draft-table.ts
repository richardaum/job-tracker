...
export class MoveDraftJobFkToDraft1763700000000 implements MigrationInterface {
  name = "MoveDraftJobFkToDraft1763700000000";
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ALTER TABLE "draft_applications" DROP COLUMN IF EXISTS "job_id";
    `);
