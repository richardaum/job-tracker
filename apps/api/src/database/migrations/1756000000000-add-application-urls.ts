...
/**
 * Adds `applications.urls` to support multiple URLs per job application.
 * Backfill: when `url` is present and `urls` is empty, copy `url` into `urls[1]`.
 */
export class AddApplicationUrls1756000000000 implements MigrationInterface {
  name = "AddApplicationUrls1756000000000";
