...
const MATCH_STATUS_TOOLTIP: Record<string, string> = {
  [AsyncMetadataStatus.Processing]: "Analyzing your resume against this job. Results will appear automatically.",
  [AsyncMetadataStatus.Completed]: "Match analysis is ready. Open to see fits, gaps, and unclear areas.",
...
export function getMatchStatusTooltipContent(status: string | AsyncMetadataStatus, error?: string | null): string {
