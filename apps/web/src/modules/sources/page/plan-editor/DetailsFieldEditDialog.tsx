...
export function DetailsFieldEditDialog({ field, open, onOpenChange, onSave, onDelete }: DetailsFieldEditDialogProps) {
  ...
  return (
    <Dialog
      ...
      description={field ? `Editing "${field.key}".` : "Define a new details field to extract from the detail page."}
        ...
        <div className={cn("flex flex-col gap-4")}>
          ...
          >
            <Select
              ...
              value={draft.type}
              onValueChange={(v) => setDraft((prev) => ({ ...prev, type: v as DetailsField["type"] }))}
            />
          </FormField>
          {draft.type === "property" ? (
            <FormField
          ...
          {draft.type === "property" ? (
            ...
            >
              <Select
                ...
                onValueChange={(v) => setDraft((prev) => ({ ...prev, format: v as "tiptap" | "salary" }))}
              />
            </FormField>
          ) : null}
        </div>
