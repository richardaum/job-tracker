...
type DeleteSourceDialogProps = { trigger: ReactElement; templateId: string; onDeleted?: (templateId: string) => void };

export function DeleteSourceDialog({ trigger, templateId, onDeleted }: DeleteSourceDialogProps) {
  const [deleteSource] = useDeleteSourceTemplateMutation({ refetchQueries: ["Plans", "SourceTemplatesAll"] });
