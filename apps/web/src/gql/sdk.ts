...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    Application(variables: ApplicationQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ApplicationQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ApplicationQuery>({ document: ApplicationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Application', 'query', variables);
    },
    CreateApplication(variables: CreateApplicationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateApplicationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateApplicationMutation>({ document: CreateApplicationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateApplication', 'mutation', variables);
    },
    ...
    UpdateApplication(variables: UpdateApplicationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateApplicationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateApplicationMutation>({ document: UpdateApplicationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateApplication', 'mutation', variables);
    },
    RemoveApplicationTag(variables: RemoveApplicationTagMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<RemoveApplicationTagMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<RemoveApplicationTagMutation>({ document: RemoveApplicationTagDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'RemoveApplicationTag', 'mutation', variables);
    },
    DeleteApplication(variables: DeleteApplicationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteApplicationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteApplicationMutation>({ document: DeleteApplicationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteApplication', 'mutation', variables);
    },
    ApplicationStageEvents(variables: ApplicationStageEventsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ApplicationStageEventsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ApplicationStageEventsQuery>({ document: ApplicationStageEventsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ApplicationStageEvents', 'query', variables);
    },
    CreateApplicationStageEvent(variables: CreateApplicationStageEventMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateApplicationStageEventMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateApplicationStageEventMutation>({ document: CreateApplicationStageEventDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateApplicationStageEvent', 'mutation', variables);
    },
    UpdateApplicationStageEvent(variables: UpdateApplicationStageEventMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateApplicationStageEventMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateApplicationStageEventMutation>({ document: UpdateApplicationStageEventDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateApplicationStageEvent', 'mutation', variables);
    },
    DeleteApplicationStageEvent(variables: DeleteApplicationStageEventMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteApplicationStageEventMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteApplicationStageEventMutation>({ document: DeleteApplicationStageEventDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteApplicationStageEvent', 'mutation', variables);
    },
    ApplicationNotes(variables: ApplicationNotesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ApplicationNotesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ApplicationNotesQuery>({ document: ApplicationNotesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ApplicationNotes', 'query', variables);
    },
    CreateApplicationNote(variables: CreateApplicationNoteMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateApplicationNoteMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateApplicationNoteMutation>({ document: CreateApplicationNoteDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateApplicationNote', 'mutation', variables);
    },
    UpdateApplicationNote(variables: UpdateApplicationNoteMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateApplicationNoteMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateApplicationNoteMutation>({ document: UpdateApplicationNoteDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateApplicationNote', 'mutation', variables);
    },
    DeleteApplicationNote(variables: DeleteApplicationNoteMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteApplicationNoteMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteApplicationNoteMutation>({ document: DeleteApplicationNoteDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteApplicationNote', 'mutation', variables);
    },
    GenerateApplicationNoteWithAi(variables: GenerateApplicationNoteWithAiQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GenerateApplicationNoteWithAiQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GenerateApplicationNoteWithAiQuery>({ document: GenerateApplicationNoteWithAiDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GenerateApplicationNoteWithAi', 'query', variables);
    },
    ...
    CompanyApplicationsCount(variables: CompanyApplicationsCountQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CompanyApplicationsCountQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CompanyApplicationsCountQuery>({ document: CompanyApplicationsCountDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CompanyApplicationsCount', 'query', variables);
    },
    ...
    DraftApplicationsList(variables?: DraftApplicationsListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DraftApplicationsListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DraftApplicationsListQuery>({ document: DraftApplicationsListDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DraftApplicationsList', 'query', variables);
    },
    DraftApplicationDetail(variables: DraftApplicationDetailQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DraftApplicationDetailQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DraftApplicationDetailQuery>({ document: DraftApplicationDetailDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DraftApplicationDetail', 'query', variables);
    },
    DeleteDraftApplication(variables: DeleteDraftApplicationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteDraftApplicationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteDraftApplicationMutation>({ document: DeleteDraftApplicationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteDraftApplication', 'mutation', variables);
    },
    DeleteApplicationsForDraft(variables: DeleteApplicationsForDraftMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteApplicationsForDraftMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteApplicationsForDraftMutation>({ document: DeleteApplicationsForDraftDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteApplicationsForDraft', 'mutation', variables);
    },
    CreateApplicationWithAiV2(variables: CreateApplicationWithAiV2MutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateApplicationWithAiV2Mutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateApplicationWithAiV2Mutation>({ document: CreateApplicationWithAiV2Document, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateApplicationWithAiV2', 'mutation', variables);
    },
    CreateDraftApplication(variables: CreateDraftApplicationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateDraftApplicationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateDraftApplicationMutation>({ document: CreateDraftApplicationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateDraftApplication', 'mutation', variables);
    },
    UpdateDraftApplication(variables: UpdateDraftApplicationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateDraftApplicationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateDraftApplicationMutation>({ document: UpdateDraftApplicationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateDraftApplication', 'mutation', variables);
    },
    FitAnalysesList(variables?: FitAnalysesListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FitAnalysesListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FitAnalysesListQuery>({ document: FitAnalysesListDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FitAnalysesList', 'query', variables);
    },
    Fit(variables: FitQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FitQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FitQuery>({ document: FitDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Fit', 'query', variables);
    },
    ApplicationFit(variables: ApplicationFitQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ApplicationFitQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ApplicationFitQuery>({ document: ApplicationFitDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ApplicationFit', 'query', variables);
    },
    DraftApplicationFit(variables: DraftApplicationFitQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DraftApplicationFitQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DraftApplicationFitQuery>({ document: DraftApplicationFitDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DraftApplicationFit', 'query', variables);
    },
    GenerateApplicationFit(variables: GenerateApplicationFitMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GenerateApplicationFitMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<GenerateApplicationFitMutation>({ document: GenerateApplicationFitDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GenerateApplicationFit', 'mutation', variables);
    },
    DeleteFitAnalysis(variables: DeleteFitAnalysisMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteFitAnalysisMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteFitAnalysisMutation>({ document: DeleteFitAnalysisDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteFitAnalysis', 'mutation', variables);
    },
