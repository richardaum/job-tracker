...
export type ParsedSalaryForCreateApplicationInput = {
...
export function isParsedSalaryForCreateApplicationInput(
  v: unknown,
): v is ParsedSalaryForCreateApplicationInput {
...
/**
 * Parses a salary line (innerText) into fields that map 1:1 onto {@link CreateApplicationInput}.
 */
export function parseSalaryInnerTextForCreateApplication(
  raw: string,
): ParsedSalaryForCreateApplicationInput | null {
