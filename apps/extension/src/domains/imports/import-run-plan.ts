...
/** First `collect.jobs` listing URL when present — persisted via `ImportRun.surfaceUrl` on the API. */
 ...
 * **`surfaceUrl`** is seeded from **`remoteyeah.plan.json`** then sent to **`updateImportRun`**.
 *
