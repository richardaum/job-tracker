...
export type ClaimSourceRunMutation = { __typename?: 'Mutation', claimSourceRun?: { __typename?: 'SourceRunType', id: string, sourceProfileId: string, status: SourceRunStatus, startedAt: any, sourceProfileSource: string } | null };
...
export type CreateApplicationMutation = { __typename?: 'Mutation', createApplication: { __typename?: 'ApplicationType', id: string, title: string } };
...
export type CreateDraftApplicationMutation = { __typename?: 'Mutation', createDraftApplication: { __typename?: 'DraftApplicationType', id: string, url?: string | null, title: string } };

export type SourceRunEventsSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type SourceRunEventsSubscription = { __typename?: 'Subscription', sourceRunEvents: { __typename?: 'SourceRunEvent', type: SourceRunEventType, occurredAt: any, run: { __typename?: 'SourceRunType', id: string, templateId: string, sourceProfileId: string, surfaceUrl: string, status: SourceRunStatus, startedAt: any, sourceProfileSource: string } } };

export type SourceRunsQueryVariables = Exact<{ [key: string]: never; }>;


export type SourceRunsQuery = { __typename?: 'Query', sourceRuns: Array<{ __typename?: 'SourceRunType', id: string, templateId: string, sourceProfileId: string, surfaceUrl: string, status: SourceRunStatus, startedAt: any, sourceProfileSource: string }> };
