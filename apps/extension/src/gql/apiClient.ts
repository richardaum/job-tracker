...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    IsJobDuplicate(variables: IsJobDuplicateQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<IsJobDuplicateQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<IsJobDuplicateQuery>({ document: IsJobDuplicateDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'IsJobDuplicate', 'query', variables);
    },
    ...
    ReportExtensionActivity(variables: ReportExtensionActivityMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ReportExtensionActivityMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ReportExtensionActivityMutation>({ document: ReportExtensionActivityDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ReportExtensionActivity', 'mutation', variables);
    },
    SourceRuns(variables?: SourceRunsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SourceRunsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SourceRunsQuery>({ document: SourceRunsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SourceRuns', 'query', variables);
    },
    UpdateSourceRunStatus(variables: UpdateSourceRunStatusMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateSourceRunStatusMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateSourceRunStatusMutation>({ document: UpdateSourceRunStatusDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateSourceRunStatus', 'mutation', variables);
    },
    UpdateSourceRun(variables: UpdateSourceRunMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateSourceRunMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateSourceRunMutation>({ document: UpdateSourceRunDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateSourceRun', 'mutation', variables);
    }
  };
}
